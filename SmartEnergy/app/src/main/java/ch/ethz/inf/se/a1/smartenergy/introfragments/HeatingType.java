...
/**
 * fragment used in an intro slide asking the user for his house' heating system preferences
 */
public class HeatingType extends Fragment implements ISlideBackgroundColorHolder {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_heating_type, container, false);
