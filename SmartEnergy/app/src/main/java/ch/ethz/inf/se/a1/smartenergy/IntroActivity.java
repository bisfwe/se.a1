...
public class IntroActivity extends AppIntro2 {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Smart Energy", "In order to store the logged data, please allow access to the storage system. Otherwise, the app can not work.", R.drawable.folder, Color.parseColor("#FFA441")));
